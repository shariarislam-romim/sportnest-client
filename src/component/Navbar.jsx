...
import { Menu, X, User, LogOut, LayoutDashboard, Volleyball } from "lucide-react";
        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="p-2 bg-green-800 rounded-xl group-hover:rotate-12 transition-transform">
          ...
          <div className="hidden md:flex gap-8 items-center">
            <Link href="/" className="font-semibold text-slate-700 hover:text-green-800 transition-colors">Home</Link>
            <Link href="/facilities" className="font-semibold text-slate-700 hover:text-green-800 transition-colors">Facilities</Link>
            <Link href="/add-facility" className="font-semibold text-slate-700 hover:text-green-800 transition-colors">Add Facility</Link>
            <Link href="/dashboard" className="font-semibold text-slate-700 hover:text-green-800 transition-colors">Dashboard</Link>
          </div>
